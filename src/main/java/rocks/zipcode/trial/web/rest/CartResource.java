...
import rocks.zipcode.trial.repository.CartRepository;
import rocks.zipcode.trial.web.rest.errors.BadRequestAlertException;
import tech.jhipster.web.util.HeaderUtil;
import tech.jhipster.web.util.ResponseUtil;

/**
 * REST controller for managing {@link rocks.zipcode.trial.domain.Cart}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Cart> partialUpdateCart(
        ...
        Optional<Cart> result = cartRepository
            ...
            .map(existingCart -> {
                ...
                if (cart.getHandle() != null) {
                    existingCart.setHandle(cart.getHandle());
                }
